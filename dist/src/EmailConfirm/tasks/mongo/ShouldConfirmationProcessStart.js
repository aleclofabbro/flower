...
exports.shouldConfirmationProcessStart = function (coll) { return function (trigger) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _id = bson_1.ObjectID.createFromHexString(trigger.id);
                return [4 /*yield*/, coll.updateOne({
                        _id: _id,
                        status: { $in: [Types_1.Status.WIP, Types_1.Status.REQ_ACCEPTED] },
                        $expr: {
            ...
            case 2: return [4 /*yield*/, coll.findOne({ _id: _id })];
            case 3:
                record = _a.sent();
                if (!record) {
                    return [2 /*return*/, {
