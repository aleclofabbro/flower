...
exports.adapt = function (domain, channel) { return __awaiter(_this, void 0, void 0, function () {
    var exchanges, queues;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                exchanges = Object.keys(domain.domainFlow);
                return [4 /*yield*/, Promise.all(exchanges.map(function (messageInName) {
                        return Promise.all([
                            ...
                            var _b = __read(_a, 2), _ = _b[0], queueResp = _b[1];
                            return (channel.bindQueue(queueResp.queue, messageInName, ''), queueResp.queue);
                        })
